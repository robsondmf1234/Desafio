...
class Mock {
    ...
    private val mListaFilme: List<Filme> = listOf(
        ...
        Filme(
            (5), R.drawable.indianajones,
            "7", "Indiana Jones", "Aventura", "Estados Unidos",
            """O arqueólogo Indiana Jones precisa encontrar a Arca da Aliança, uma relíquia
            bíblica que contém os dez mandamentos.Como o portador do artefato se torna invencível,
            os nazistas também vão fazer de tudo para adquirir esse precioso objeto.
        """.trimIndent()
        ),
        Filme(
            (6), R.drawable.johnwick,
            "8.5", "John Wick", "Acao", "Estados Unidos",
            """John Wick é um lendário assassino de aluguel aposentado, lidando com o luto
            após perder o grande amor de sua vida. Quando um gângster invade sua casa, mata
            seu cachorro e rouba seu carro, ele é forçado a voltar à ativa e inicia sua vingança.
            """.trimIndent()
        ),
        Filme(
            (7), R.drawable.alien,
            "8.5", "Alien", "Ficcao", "Estados Unidos",
            """Uma nave espacial, ao retornar para Terra, recebe estranhos sinais vindos
            de um asteroide. Enquanto a equipe investiga o local, um dos tripulantes é atacado
            por um misterioso ser. O que parecia ser um ataque isolado se transforma em um terror
            constante, pois o tripulante atacado levou para dentro da nave o embrião de um alienígena,
            que não para de crescer e tem como meta matar toda a tripulação.
            """.trimIndent()
        ),
        Filme(
            (8), R.drawable.titanic,
            "9.0", "Titanic", "Drama", "Estados Unidos",
            """Um artista pobre e uma jovem rica se conhecem e se apaixonam na fatídica jornada
            do Titanic, em 1912. Embora esteja noiva do arrogante herdeiro de uma siderúrgica, a
            jovem desafia sua família e amigos em busca do verdadeiro amor.
            """.trimIndent()
        ),
        Filme(
            (9), R.drawable.bohemia,
            "9", "Bohemia Rapsody", "Drama", "Estados Unidos",
            """Freddie Mercury, Brian May, Roger Taylor e John Deacon formam a banda de rock Queen
            em 1970. Quando o estilo de vida agitado de Mercury começa a sair de controle, o grupo
            precisa encontrar uma forma de lidar com o sucesso e os excessos de seu líder.
            """.trimIndent()
        ),
        Filme(
        ...
        Filme(
            ...
            """Os grandes amigos Seth Rogen e Jay Baruchel vão em uma festa na casa do ator
            James Franco, que reuniu diversas celebridades no local, como Jonah Hill, Rihanna,
            Jason Segel e Emma Watson. Tudo corria bem até que um aparente terremoto se revela
            como sendo o dia do julgamento final. Rogen, Baruchel, Franco, Hill, Danny McBride
            e Craig Robinson acabam se vendo presos no local na torcida para que o mundo pare de acabar do lado de fora.
            """.trimIndent()
        ),Filme(
            (12),R.drawable.guardiaodasgalaxias,
            "9.0","Guardiões das Galacias","Comedia","Estados Unidos",
            """Os Guardiões precisam lutar para manter sua recém descoberta família unida, enquanto
            descobrem os mistérios sobre o verdadeiro pai de Peter Quill.
            """.trimIndent()
        ),Filme(
            (13),R.drawable.sebebernaocase,
            "8.0","Se Beber não case","Comedia","Estados Unidos",
            """Se Beber, Não Case. Quando Doug está prestes a se casar, seus amigos Phill e Stu
            decidem que a despedida de solteiro será inesquecível. Para isso, eles organizam uma viagem
            em que os três passarão uma noite juntos em Las Vegas, onde qualquer coisa pode acontecer.
            """.trimIndent()
        ),Filme(
            (14),R.drawable.poderosochefao,
